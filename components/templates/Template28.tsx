...
export function generateTemplate28Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#4338CA'; // Indigo & Lime Primary
  const secondaryColor = '#84CC16'; // Indigo & Lime Secondary
  const accentColor = '#818CF8';
  const darkColor = '#312E81';
