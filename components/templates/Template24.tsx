...
export function generateTemplate24Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#7C3AED'; // Purple & Pink Primary
  const secondaryColor = '#DB2777'; // Purple & Pink Secondary
