...
export function generateTemplate19Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  const backgroundColor = '#F5F8FA';
const primaryColor = '#0F2862';
const secondaryColor = '#9E363A';
const accentColor = '#4F5F76';
const textColor = '#091F36';
const cardBg = '#FFFFFF';
