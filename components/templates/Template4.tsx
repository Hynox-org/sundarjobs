...
const backgroundColor = '#FFF9F5';      // Cream white
const primaryColor = '#FF6B35';         // Coral orange
const secondaryColor = '#FFC93C';       // Golden yellow
const accentColor = '#F95F62';          // Pink-red
