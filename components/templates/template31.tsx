...
export function generateTemplate31Html({ formData }: { formData: JobPostFormData }): string {
    if (!formData) return '<h1>Loading...</h1>';

    // Vibrant Coral-Teal Color Scheme
    const primaryColor = '#FF6B6B'; // Coral red
    const secondaryColor = '#4ECDC4'; // Teal/turquoise
    const accentColor = '#FFE66D'; // Sunny yellow
    const darkColor = '#2D3142'; // Charcoal
    const lightColor = '#FFF5E6';
    const pinkColor = '#FF9FF3';
