...
export function generateTemplate25Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#0D9488'; // Teal & Coral Primary
  const secondaryColor = '#FF7F50'; // Teal & Coral Secondary
