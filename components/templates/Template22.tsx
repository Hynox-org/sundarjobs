...
export function generateTemplate22Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#1E40AF'; // Royal Blue & Gold Primary
  const secondaryColor = '#F59E0B'; // Royal Blue & Gold Secondary
