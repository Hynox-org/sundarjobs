...
export function generateTemplate30Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#0891B2'; // Cyan & Magenta Primary
  const secondaryColor = '#C026D3'; // Cyan & Magenta Secondary
