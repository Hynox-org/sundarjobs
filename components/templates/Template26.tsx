...
export function generateTemplate26Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#EA580C'; // Orange & Navy Primary
  const secondaryColor = '#1E3A8A'; // Orange & Navy Secondary
