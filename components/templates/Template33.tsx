...
export function generateTemplate33Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Vibrant Coral-Teal Color Scheme
  const primaryColor = '#8B5CF6'; // Purple & Orange Punch Primary
  const secondaryColor = '#F97316'; // Purple & Orange Punch Secondary
  const accentColor = '#FBBF24';
  const darkColor = '#4C1D95';
  const lightColor = '#F5F3FF';
  const pinkColor = '#F472B6';
