...
export function generateTemplate15Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

const backgroundColor = '#FFF8F5';
const primaryColor = '#E05915';
const secondaryColor = '#CDD422';
const accentColor = '#431C5D';
