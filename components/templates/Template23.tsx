...
export function generateTemplate23Html({ formData }: { formData: JobPostFormData }): string {
  if (!formData) return '<h1>Loading...</h1>';

  // Bold Green-Yellow Color Scheme
  const primaryColor = '#DC2626'; // Crimson Red & Charcoal Primary
  const secondaryColor = '#1F2937'; // Crimson Red & Charcoal Secondary
